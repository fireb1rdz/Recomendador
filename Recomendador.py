filmes = {
    ...
    2: {"titulo": "Interestelar", "categoria": "Ficção Científica", "avaliacao": 4.8, "favorito": False,
        "assistido": False},
    ...
    7: {"titulo": "Mad Max: Estrada da Fúria", "categoria": "Ação", "avaliacao": 4.7, "favorito": False,
        "assistido": False},
    8: {"titulo": "Superbad", "categoria": "Comédia", "avaliacao": 4.1, "favorito": False, "assistido": False},
    9: {"titulo": "Se Beber, Não Case!", "categoria": "Comédia", "avaliacao": 4.0, "favorito": False,
        "assistido": False},
    ...
    12: {"titulo": "Blade Runner 2049", "categoria": "Ficção Científica", "avaliacao": 4.6, "favorito": False,
         "assistido": False},
    13: {"titulo": "A Origem", "categoria": "Ficção Científica", "avaliacao": 4.7, "favorito": False,
         "assistido": False},
    ...
    18: {"titulo": "Diário de uma Paixão", "categoria": "Romance", "avaliacao": 4.3, "favorito": False,
         "assistido": False},
    19: {"titulo": "Orgulho e Preconceito", "categoria": "Romance", "avaliacao": 4.2, "favorito": False,
         "assistido": False},
    20: {"titulo": "Harry Potter e a Pedra Filosofal", "categoria": "Fantasia", "avaliacao": 4.7, "favorito": False,
         "assistido": False},
    21: {"titulo": "O Senhor dos Anéis: A Sociedade do Anel", "categoria": "Fantasia", "avaliacao": 4.8,
         "favorito": False, "assistido": False},
    22: {"titulo": "Seven: Os Sete Crimes Capitais", "categoria": "Suspense", "avaliacao": 4.6, "favorito": False,
         "assistido": False},
    23: {"titulo": "Psicose", "categoria": "Suspense", "avaliacao": 4.5, "favorito": False, "assistido": False},
    24: {"titulo": "A 13ª Emenda", "categoria": "Documentário", "avaliacao": 4.8, "favorito": False,
         "assistido": False},
    25: {"titulo": "A Marcha dos Pingüins", "categoria": "Documentário", "avaliacao": 4.3, "favorito": False,
         "assistido": False},
}
